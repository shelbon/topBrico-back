insert into ville(id_ville, cd_insee, cp, nom_ville) VALUES (1,'0075','0075','Paris');
insert into ville(id_ville, cd_insee, cp, nom_ville) VALUES (2,'94600','0094600','Choisy le roi');

insert into client(id_client, email_client, mdp_client, nom_client, prenom_client, ville_id_ville) VALUES (1,'email@client.com', 'mdp123','nomClient','prenomClient',1);
insert into client(id_client, email_client, mdp_client, nom_client, prenom_client, ville_id_ville) VALUES (2,'email@client2.com', 'mdp123','nomClient2','prenomClient2',2);
...
insert into commentaire(id_com, data_com, note, text_com, artisan_id_artisan, client_id_client) VALUES (1, '2022-01-01',5 ,'text commentaire client 2 artisant 2', 2, 2);
